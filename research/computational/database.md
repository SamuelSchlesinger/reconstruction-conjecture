...
- **Current stable: 2.9.x**; the older 2.8.x series remains
  source-compatible. See the canonical entry in
  [`../sources.md#nauty-manual`](../sources.md#nauty-manual) for the
  official user guide covering both the 2.8.x and 2.9.x series.
