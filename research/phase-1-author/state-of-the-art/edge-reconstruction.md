...
- **Müller 1977** [muller77][muller77]. If `|E(G)| > (n - 1) · log_2 n`
...
- **Graphs with more than `n log n` edges** (Müller, above) — dense
  regime.
...
- **Sparse graphs.** Below the `(n - 1) log_2 n` threshold, general
