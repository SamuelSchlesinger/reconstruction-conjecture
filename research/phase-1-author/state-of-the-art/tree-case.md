...
- **Harary–Palmer (1966).** Introduced the "pruning sequence" viewpoint
  and reduced tree reconstruction to reconstructing the centre together
  with its subtree multiplicities. The proof fits on a page. (Primary
  source: F. Harary, E. M. Palmer, *On the problem of reconstructing a
  tournament from subtournaments*, Monatshefte für Mathematik 71 (1967),
  14–23 — but note that paper is primarily about tournaments; the tree
  proof appears in their 1966 tree paper whose exact citation should be
  verified.)
