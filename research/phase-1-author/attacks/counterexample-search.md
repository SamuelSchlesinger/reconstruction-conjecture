...
| post-2000 | up to $n \le 13$ or higher | various | **Verify** — bounds in this range appear in secondary sources; the definitive current bound should be checked against McKay's web pages and recent surveys |
...
1. **Exponential growth of the search space.** The number of
   ...
   $2^{\binom{n}{2}}/n!$ — for $n = 12$ this is already on the order
   of $10^{18}$, and for $n = 13$ around $10^{22}$. Checking each
