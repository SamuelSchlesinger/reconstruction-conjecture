...
- **McKay 1997** (`n ≤ 11`). Machine-months on 1990s workstations;
  the 2012 "Computational Combinatorics" blog retrospective quotes
  the work as completed "before 1998" [compcom12][compcom12]. Exact
  CPU figures not tabulated in the paper itself
  ([mckay97][mckay97]).
- **McKay 2022** (`n ≤ 13`). Large parallel run on a university
  ...
  | Triangle-free graphs | 14 | [mckay22][mckay22] |
  | Square-free graphs | 15 | [mckay22][mckay22] |
  | Bipartite graphs | 15 | [mckay22][mckay22] |
...
[compcom12]: ../sources.md#compcom12
